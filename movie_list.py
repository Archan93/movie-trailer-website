...
Iron_man_1 = movie_class.Movies("Iron Man 1",
...
Batman_Begins = movie_class.Movies("Batman_Begins",
...
Green_Lantern = movie_class.Movies("Green Lantern",
